...
func (s *Server) initializeRoutes() {
	...
	v1 := s.Router.Group("/api/v1")
	{
		...
		//Posts routes
		v1.POST("/posts", middlewares.TokenAuthMiddleware(), s.CreateComment)
		v1.GET("/posts", s.GetComments)
		v1.GET("/posts/:id", s.GetComments)
		v1.PUT("/posts/:id", middlewares.TokenAuthMiddleware(), s.UpdateComment)
		v1.DELETE("/posts/:id", middlewares.TokenAuthMiddleware(), s.DeleteComment)
		v1.GET("/user_posts/:id", s.GetUsers)
